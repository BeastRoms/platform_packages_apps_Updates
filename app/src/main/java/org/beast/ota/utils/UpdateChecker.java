...
import org.beast.ota.UpdaterApplication;
import org.beast.ota.activities.UpdaterActivity;
import org.beast.ota.misc.Constants;
import org.beast.ota.misc.State;
import org.beast.ota.misc.UpdateInfo;
import org.beast.ota.requests.UpdatesJsonObjectRequest;
import org.beast.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "org.beast.ota.action.UPDATE_CHECK_FINISHED";
